...
% The value used for the dataAcquisitionModule Module's 'dataAcquisitionModule/bit' parameter: This
...
ziDAQ('set', h, 'dataAcquisitionModule/grid/cols', 2^p.Results.dataAcquisitionModule_bit);
...
ziDAQ('set', h, 'dataAcquisitionModule/triggernode', ['/' device '/demods/' demod_c '/sample.r']);
...
buffer_size = ziDAQ('getDouble', h, 'dataAcquisitionModule/buffersize');
