...
% The value later used for the SW Trigger's 'dataAcquisitionModule/duration' parameter:
...
% The value later used for the SW Trigger's 'dataAcquisitionModule/delay' parameter: This
...
% The value later used for the SW Trigger's 'dataAcquisitionModule/level' parameter: This
...
% ziDAQ('set', h, 'dataAcquisitionModule/bitmask', 1);
% ziDAQ('set', h, 'dataAcquisitionModule/bits', 1);
