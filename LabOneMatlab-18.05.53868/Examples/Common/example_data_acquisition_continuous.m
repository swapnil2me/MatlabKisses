function [data] = example_data_acquisition_continuous(device_id)
...
ziDAQ('set', h, 'dataAcquisitionModule/grid/mode', 2);
...
ziDAQ('set', h, 'dataAcquisitionModule/count', num_bursts);
...
ziDAQ('set', h, 'dataAcquisitionModule/duration', burst_duration);
