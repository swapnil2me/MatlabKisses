...
% Put all amplitudes at zero
ziDAQ('setDouble', ['/' device '/sigouts/' out_c '/amplitudes/*'], 0.0);
% Enable the output mixing channel
...
ziDAQ('setDouble', ['/' device '/scopes/0/length'], 10000);
...
time_expected = linspace(0, 4*AWG_N/freqSamp, 4*AWG_N) + time_shift;
% Plot
...
if norm_correlation_coeff > 0.95
    ...
    fprintf('Detected a disagreement between the measured and expected signals, normalized correlation coefficient: %f.\n', norm_correlation_coeff);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
end
