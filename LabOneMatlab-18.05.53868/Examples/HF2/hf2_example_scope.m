...
%     recording.
ziDAQ('set', scopeModule, 'scopeModule/mode', 1);
...
ziDAQ('set', scopeModule, 'scopeModule/averager/weight', 1);
% 'scopeModule/historylength' : The number of scope records to keep in
...
ziDAQ('set', scopeModule, 'scopeModule/historylength', 20);
...
ziDAQ('set', scopeModule, 'scopeModule/externalscaling', externalscaling)
...
ziDAQ('set', scopeModule, 'scopeModule/mode', 3);
% Use a Hann window function.
ziDAQ('set', scopeModule, 'scopeModule/fft/window', 1);
...
% GETSCOPERECORDS  Obtaining scope records from device using an Scope Module.
  ...
  while records < num_records
    pause(0.5)
    records = ziDAQ('getInt', scopeModule, 'scopeModule/records');
